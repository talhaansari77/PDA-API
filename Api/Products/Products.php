...
switch ($_SERVER["REQUEST_METHOD"]) {
    ...
    case 'POST':
        ...
        if ( isset($_POST['title']) && isset($_POST['description']) && isset($_POST['price']) && is_uploaded_file($_FILES["picture"]["tmp_name"])) {
            ...
            VALUES (NULL, '{$_POST['title']}', '{$_POST['description']}', '{$_POST['price']}', '{$file_destinationG}', '{$_POST['menuId']}', '{$_POST['catId']}' ,'{$_POST['shopId']}')";
